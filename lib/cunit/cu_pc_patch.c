...
static void test_schema_xy() {
  ...
  */
  static char *hexpt =
      "01010000000AE9C90307A1100522A5000019000101010001067C9F1C4953C474650A0E41"
...
static void test_patch_filter() {
  ...
  // PCPATCH* pc_patch_filter(const PCPATCH *pa, uint32_t dimnum, PC_FILTERTYPE
  // filter, double val1, double val2);
