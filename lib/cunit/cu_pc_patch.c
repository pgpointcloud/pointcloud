...
static void test_patch_hex_in()
{
    ...
    char *hexbuf =
        "0000000000000000000000000200000002000000030000000500060000000"
...
static void test_patch_hex_out()
{
    ...
    static char *hexresult_xdr =
        "00000000000000000000000002000000020000000300000"
...
static void test_patch_dimensional_compression()
{
    ...
    CU_ASSERT_STRING_EQUAL(
        str,
        "{\"ndims\":4,\"total_points\":1200,\"total_patches\":3,\"dims\":[{"
...
static void test_patch_pointn_last_first()
{
    ...
    char *hexbuf =
        "0000000000000000000000000300000008000000030000000500060000000"
...
static void test_patch_range_compression_none()
{
    ...
    CU_ASSERT_STRING_EQUAL(str,
                           "{\"pcid\":0,\"pts\":[[15,15,1.5,85],[16,16,1.6,"
...
static void test_patch_range_compression_none_with_full_range()
{
    ...
    str = pc_patch_to_string(par);
    CU_ASSERT_STRING_EQUAL(str,
                           "{\"pcid\":0,\"pts\":[[0,0,0,100],[1,1,0.1,99],["
...
test_patch_range_compression_dimensional(enum DIMCOMPRESSIONS dimcomp)
{
    ...
    CU_ASSERT_STRING_EQUAL(
        str, "{\"pcid\":0,\"pts\":[[9986,9986,9986,10],[9985,9985,"
...
static void test_patch_set_schema_compression_none()
{
    ...
    CU_ASSERT_STRING_EQUAL(str,
                           "{\"pcid\":0,\"pts\":[[0.4,0.8,1.2],[0.3,0.6,0.9]"
    ...
    CU_ASSERT_STRING_EQUAL(
        str, "{\"pcid\":0,\"pts\":[[0.4,0.8,1.2,0],[0.3,0.6,0.9,0],"
...
static void test_patch_set_schema_compression_none_offset()
{
    ...
    CU_ASSERT_STRING_EQUAL(
        str, "{\"pcid\":0,\"pts\":[[0.4,0.8,1.2,10],[0.3,0.6,0.9,"
