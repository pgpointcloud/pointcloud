...
def read_version(filename):
    ...
    return re.search(r'\d.\d.\d', data).group(0)

release = read_version('../Version.config')
version = release
...
htmlhelp_basename = 'pgpointclouddoc'
...
latex_documents = [
        (master_doc, '%s.tex'% project, u'pgPointcloud - A PostgreSQL extension for storing point cloud (LIDAR) data.',
         r'Paul Ramsey\\Paul Blottiere\\Mathieu Brédif\\Eric Lemoine', 'manual'),
]
